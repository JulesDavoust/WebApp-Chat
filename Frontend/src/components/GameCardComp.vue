...
export default {
    ...
    methods:{
        ...
        async followGame(){
            ...
            console.log(idGame)
            await fetch(`http://172.31.44.54:8080/api/follows/follow`,
            {
                method: 'POST',
        ...
        async unfollowGame(){
            ...
            const idGame = this.idGame
            console.log(idGame)
            await fetch(`http://172.31.44.54:8080/api/follows/unfollow`,
            {
                method: 'DELETE',
                headers: Object.assign({ 'Content-Type': 'application/json' }, AuthService.authHeader()),
                body: JSON.stringify({idGame}) 
    ...
    async created(){
        ...
        let Game
        await fetch(`http://172.31.44.54:8080/api/follows/verifFollow`,
        {
