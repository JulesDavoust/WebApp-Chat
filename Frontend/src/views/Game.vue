...
export default {
    ...
    data(){
        return{
            ...
            messages:[],
            pseudo:'',
            socket : io('http://13.39.240.4:8080')
        }
    },
    methods:{
        joinServer(){
    ...
    async mounted(){
        ...
        // });
        const userId = 3;
        fetch(`http://13.39.240.4:8080/api/users/getPseudoById`,
        {
        ...
        fetch(`http://13.39.240.4:8080/api/intern/getOneGame/${paramsId}`)
        .then(response=>response.json())
        .then(data => {
        ...
        fetch(`http://13.39.240.4:8080/api/intern/getDiscussion/${paramsIdDiscussion}`)
        .then(response=>response.json())
        .then(data => {
            console.log('my data : ',data);
