...
export default {
    ...
    methods:{
        async submit(){
            ...
            this.isLoading = true;
            await fetch(`http://15.236.86.190:8080/api/intern/searchGame/${queryParams}`)
    ...
    async created(){
        await fetch("http://15.236.86.190:8080/api/intern/allPlatformsGame")
        .then(response => response.json())
        .then(data =>{
            this.Platforms = data;
        ...
        await fetch("http://15.236.86.190:8080/api/intern/allTypesGame")
        .then(response => response.json())
        .then(data => {
            this.typesGame = data;
        ...
        await fetch("http://15.236.86.190:8080/api/intern/allPublishersGame")
        .then(response => response.json())
        .then(data => {
            this.publishersGame = data
        })

        await fetch("http://15.236.86.190:8080/api/intern/allYearsGame")
        .then(response => response.json())
        .then(data => {
            this.yearsGame = data
        })
